...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        prompt: str = Input(
            ...
            default="A cinematic shot of a racoon wearing an intricate italian robe, with a crown"
        ),
        ...
        guidance_scale: float = Input(
            description="Scale for classifier-free guidance", ge=1, le=50, default=9.0
        ),
